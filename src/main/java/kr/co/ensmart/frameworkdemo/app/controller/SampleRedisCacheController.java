...
import kr.co.ensmart.frameworkdemo.app.service.SampleRedisCacheService;
...
public class SampleRedisCacheController {
    @Autowired
    private SampleRedisCacheService sampleService;
    ...
    public User modifyUserById(User user) {
        return sampleService.modifyByUserId(user);
    }
